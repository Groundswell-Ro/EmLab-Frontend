...
std::unique_ptr<Wt::WContainerWidget> UserProfile::createSettings()
{
    std::unique_ptr<Wt::WContainerWidget> returnWidget = std::make_unique<Wt::WContainerWidget>();
...
std::unique_ptr<Wt::WTemplate> UserProfile::createSettingsGeneralWidget(std::string tempName)
{
...
std::unique_ptr<Wt::WTemplate> UserProfile::createChangeEmailWidget(std::string tempName)
{
...
std::unique_ptr<Wt::WTemplate> UserProfile::createChangeUsernameWidget(std::string tempName)
{
auto widget_tmp = std::make_unique<Wt::WTemplate>(tr(tempName));
...
std::unique_ptr<Wt::WTemplate> UserProfile::createChangeNameWidget(std::string tempName)
{
auto widget_tmp = std::make_unique<Wt::WTemplate>(tr(tempName));
...
std::unique_ptr<Wt::WTemplate> UserProfile::createChangePhoneWidget(std::string tempName)
{
auto widget_tmp = std::make_unique<Wt::WTemplate>(tr(tempName));
...
std::unique_ptr<Wt::WTemplate> UserProfile::createChangePasswordWidget(std::string tempName)
{
    auto widget_tmp = std::make_unique<Wt::WTemplate>(tr(tempName));
