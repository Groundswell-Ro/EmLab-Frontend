...
void PortofoliosPage::createSidebar()
{
	...
	save_event_btn_->clicked().connect(this, &PortofoliosPage::saveEvent);
...
void PortofoliosPage::cancelEvent()
{
	std::cout << "\n cancel event \n";
	add_event_btn_->removeStyleClass("-translate-x-32");
	save_event_btn_->addStyleClass("-translate-x-28");
...
void PortofoliosPage::calendarClicked(const Wt::WDate date)
{
